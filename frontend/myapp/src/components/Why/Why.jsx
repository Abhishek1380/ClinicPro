...
const Why = () => {
    ...
    return (
        <section class="section_container why_container">
            <div class="why_image">
                <img src="https://i.ibb.co/PrkHMMG/beautiful-young-female-doctor-looking-camera-office-1301-7807.jpg" alt="beautiful-young-female-doctor-looking-camera-office-1301-7807" border="0" />
            </div>
            <div class="why_flex">
